...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--iterations', type=int, help='number of iterations', default=50)
    ...
    sim_kwargs = { 'sensors':[0], 'resolution': (1080, 1920), 'headless': True, 'fov': 135, 'random_seed': args.seed}
    ...
    if args.task == 'goat':
        exp_kwargs = {'split': args.split, 'num_scenes': 5}
